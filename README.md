...
* **멀티 셀렉트**: 앱(체크박스)을 여러 개 동시에 선택하여 일괄 처리할 수 있습니다.
...
* **완전 복원 (Restore)**: 실수로 완전 삭제해버린 '기본 시스템 앱'을 원래대로 복원시킵니다.
* 🎓 **공신폰 모드 전용 (방해앱+잉여앱 올인원 선택)**: 버튼 하나만 클릭하면 학생들에게 공부 방해가 되는 앱과 시스템 잉여 앱을 모두 한 번에 찾아 체크해줍니다. 이후 [비활성화] 또는 [완전 삭제]를 선택해 처리할 수 있습니다. 
  *(지원 목록: Google Play Store, 원스토어, 갤럭시 스토어, Chrome, 삼성 인터넷, YouTube, YouTube Music, Netflix, Facebook, Instagram, TikTok, Twitter, 빅스비, AR존(두들/이모지), Gmail, Google Meet, Samsung Free, 게임런처, 삼성 팁 등)*
