...
### Mac
* 배포된 `Kongsin App Manager-2.0.0-arm64-mac.zip` 압축을 풀고 `Kongsin App Manager.app`을 실행합니다.

### Windows (Intel/AMD/ARM64 호환)
* 배포된 `Kongsin App Manager Setup 2.0.0.exe` 인스톨러를 실행하여 설치 및 실행합니다.
