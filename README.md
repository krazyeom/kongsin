...
* 🎓 **공신폰 모드 전용 원클릭 설정**: 학생들에게 공부 방해가 되는 스토어, 유튜브, SNS, 브라우저 등을 한 번에 찾아서 체크해 줍니다. 
  *(지원 목록: Google Play Store, 원스토어, 갤럭시 스토어, Chrome, 삼성 인터넷, YouTube, YouTube Music, Netflix, Facebook, Instagram, TikTok, Twitter 등)*
* 🧹 **삼성/구글 잉여앱 자동선택**: 빅스비, AR존 등 지워도 상관없는 쓰레기 앱들을 한 번에 자동으로 찾아서 체크해 줍니다.
